      ...
      <section className="py-16">
        ...
        <div className="max-w-4xl text-muted-foreground text-sm text-justify leading-relaxed">
          <p className="mt-2 mb-4">
            I build AI systems that actually ship — from fine-tuned models
            hitting 90% reasoning accuracy to no-code agent platforms
            processing thousands of autonomous workflows. Every project
            here started from a real problem and ended with a working system.
          </p>
        </div>
      </section>
